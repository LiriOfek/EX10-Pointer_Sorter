...
Purpose: This file initiate array in size 10, that contain pointers to
		 ...
		 and sort the values of pointer array by swap pointers
\********************************************************/
...
#define PRINT_POINTER_ARRAY_AFTER_SORT_VALUES_BY_SWAP_POINTERS ("\npointer array after sort their values by swap the pointers:\n")

void bubble_sort_by_swap_pointers(int *pointer_array[SIZE], int size_of_array)
{
	/********************************************************\
	* Function name - bubble_sort_by_swap_pointers
	*
	* Function Purpose - sort given array in ascending order of elements,
	*					 by swap the pointers
	*
	...
	*				 sort the given array by swap the pointers
	*
...
void main() {
	...
	* Author - Liri
	...
	bubble_sort_by_swap_pointers(pointer_array, SIZE);

	printf(PRINT_POINTER_ARRAY_AFTER_SORT_VALUES_BY_SWAP_POINTERS);
	print_index_address_value_of_pointers(pointer_array);
}